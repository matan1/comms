...
# Design: docs/embeddable-harness-v1.md. This is your door; edit freely.
...
See `docs/embeddable-harness-v1.md` for the design and the Comms Attest spec for
the protocol.
"#;
...
See `docs/embeddable-harness-v1.md` for the design.
"#;
