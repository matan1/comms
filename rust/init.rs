...
# The custodian's side of the wall: custody is content-addressed and boring,
# browsing is a regenerable view. See door.md beside this file.
schema = "comms-harness/1"
profile = "archive"

[archive]
# This door IS the archive: store/ bodies/ intake/ views/ genesis/ live at
# the root beside .comms/.
mode = "local"
...
# Artifact types name view files at intake — the same schema that drives a
# repo door drives the archive, so both sides of the wall speak one config.
[artifact_types.letters]
dir = "letters"
...
The custodian's side of the wall. One principle: **custody and browsing are
different things.**
...
- `views/`   — regenerable, human-named trees built FROM custody by the tool.
               Safe to delete at any time; never the archive.
